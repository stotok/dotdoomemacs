;;; ttk-doom-one-light-theme.el --- inspired by Atom One Light -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme ttk-doom-one-light
  ...
  (((font-lock-comment-face &override)
   ...
   (org-block-begin-line :foreground base2 :extend t) ; totok to make blurr
   ...
   (vertico-current :background bg-alt :underline t)    ; totok to make it more obvious with underline
   ;;;; solaire-mode
...
;;; ttk-doom-one-light-theme.el ends here
