;;; ttk-doom-homage-white-theme.el --- minimal white theme inspired by editors from 2000s -*- no-byte-compile: t; -*-
;;;
;;; Commentary:
;;;
...
;;
(def-doom-theme ttk-doom-homage-white
  ...
  ((bg         '("#fafafa" nil       nil            ))
   ...
   (builtin        fg)
   ;; (comments       green)
   (comments       base4)               ; totok make comment darker
...
;;; ttk-doom-homage-white-theme.el ends here
