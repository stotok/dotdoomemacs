;;; ttk-doom-solarized-light-theme.el --- inspired by Atom One Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(def-doom-theme ttk-doom-solarized-light
...
;;; ttk-doom-solarized-light-theme.el ends here
